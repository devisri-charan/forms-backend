...
export interface ApiFormForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    submission_settings: Attribute.JSON;
...
export interface ApiFormFieldFormField extends Schema.CollectionType {
  ...
  attributes: {
    ...
    field_type: Attribute.Enumeration<
      ['text', 'textarea', 'checkbox', 'radio', 'dropdown', 'date']
    >;
    placeholder: Attribute.String;
    validation_rules: Attribute.JSON;
    order: Attribute.Integer;
    is_required: Attribute.Boolean;
    options: Attribute.Component<'options.field-options', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSectionSection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    order: Attribute.Integer;
    form_fields: Attribute.Relation<
      'api::section.section',
      'oneToMany',
      'api::form-field.form-field'
    >;
